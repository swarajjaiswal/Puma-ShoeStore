...
const About = () => {
    return (
        <>
            ...
            <div className='bg-zinc-300 min-h-screen overflow-hidden'>
                <div className="container mx-auto px-0">
                    <div className='flex flex-col my-10 font-extrabold text-left'>
                        <span className='text-6xl md:text-8xl lg:text-9xl leading-tight text-gray-800'>WE</span>
                        <span className='text-6xl md:text-8xl lg:text-9xl leading-tight text-gray-800'>SERVE</span>
                        <span className='text-6xl md:text-8xl lg:text-9xl leading-tight text-gray-800'>ATHLETES*</span>
                    </div>
                    <span className='block mx-auto mt-6 text-xl md:text-2xl lg:text-3xl italic font-bold p-3 text-left text-gray-600'>
