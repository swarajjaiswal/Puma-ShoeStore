    ...
    return (
        <>
            <div className='Cart bg-black w-full min-h-screen  p-4 md:p-8'>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className='flex flex-col md:flex-row items-center justify-between w-full mt-4 md:mt-0 md:ml-4'>
                                <h1 className='font-bold text-lg md:text-xl text-white'>{item.title}</h1>
                ...
                {totalBill ? <div className='mt-10 p-6  text-white rounded-lg shadow-lg' style={{ background: 'linear-gradient(90deg, #ff0057 0%, #673ab7 34%, #3f51b5 40%, #ff5722 68%, #e91e63 80%, #f44336 100%)' }}>
