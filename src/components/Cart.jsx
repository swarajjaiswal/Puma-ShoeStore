...
const Cart = () => {
    ...
    return (
        <>
        <div className='Cart bg-white w-full min-h-screen text-black p-4 md:p-8'>
            <div className='flex flex-col md:flex-row items-center justify-between border-b-2 pb-4'>
                <h1 className='text-3xl md:text-4xl lg:text-5xl mt-2 font-extrabold'>Cart Details</h1>
                {cart.items.length > 0 && (
            ...
            {cart.items.length > 0 ? (
                cart.items.map((item) => {
                    ...
                    return (
                        <div key={item.id}
                            className="cart-details mx-auto my-5 w-full md:w-11/12 lg:w-4/5 flex flex-col md:flex-row justify-between items-center bg-gray-100 p-4 rounded-lg shadow-lg transition-transform transform hover:scale-105 duration-300"
                        >
                ...
                <h1 className='text-center text-2xl md:text-3xl lg:text-4xl mt-20'>Your cart is empty</h1>
            )}
            <div className='mt-10 p-6 bg-gradient-to-r from-green-400 to-blue-500 text-white rounded-lg shadow-lg'>
