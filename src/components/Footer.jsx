...
const Footer = () => {
    return (
        ...
        <footer id="footer" className="foot1  mt-5 h-full">
            <div className=" footer   flex p-10 ">
                <div className=" left1 flex flex-1 footer-color justify-between px-8 py-4  mx-3">
            ...
            <h1 className='text-center mb-3 font-bold text-md w-full p-1 athelete-text'>CopyRight &copy; Swaraj Jaiswal. All Rights Reserved 2024</h1>
        </footer>
    );
}
